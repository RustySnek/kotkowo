...
config :kotkowo, :token_signing_secret, "very_secret_key :)"
...
config :kotkowo, KotkowoWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "/scnF5KvL94qauNtGFgOfOhItcFrgRVjMSDEkh6YHtdMqKV+Lj7o8P9mX1cQ/YQC",
  watchers: [
...
config :kotkowo, dev_routes: true
